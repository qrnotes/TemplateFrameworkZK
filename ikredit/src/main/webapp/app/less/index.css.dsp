...
/* rubah warna button */
.z-button {
  background-color:#20b2aa !important;border-color:#20b2aa;
  position: relative;
  padding: 3px 12px;
   ${ t:borderRadius('0') };
...
/* tambahan */
	...
	.z-listheader {
	  background: -webkit-linear-gradient(top,#7be97b 0%, #7be97b 100%);
	  background: linear-gradient(to bottom, #7be97b 0%,#7be97b 100%);		
	}    
